			...
			return (
				...
				>
					...
					<div className='overlay'>
						...
						<h1 className='captionName'> {item.caption}</h1>

						<div style={{ justifyContent: 'space-around' }}> {item.category} </div>
						<br />
						<button className='watcht'> Watch Trailer &nbsp;&nbsp; <i className='fa fa-play'></i></button>
						<br /><br /><br />
						<p style={{ marginBottom: 0 }}>In Cinemas</p>
						<h2 style={{ marginTop: 0, color: 'gold' }}>{item.date}</h2>
					</div>
				</CarouselItem>
			);
		});
